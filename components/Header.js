                    ...
                    <div className={styles['lines-header']}>
                        <div className={styles['properties-header']}>
                            <ul className={styles['header-links']}>
                                <li className={`${styles['nav-links']} ${styles['hommer']}`}><Link href='/' className={styles['react-link-home']}><i className={styles['home-logo']}><FaHome /></i></Link></li>
                                <li className={`${styles['nav-links']} ${styles['first']}`}><Link href='/' className={styles['react-link-home']}>Men&apos;s Shoes<FaChevronDown className={styles['chevron']} /></Link></li>
